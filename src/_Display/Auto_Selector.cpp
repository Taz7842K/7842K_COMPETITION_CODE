...
namespace lib7842
{
  ...
  m_autonPairs(autonPairs)
  {
    ...
    lv_color_t mainColor = LV_COLOR_WHITE;
    ...
    style_bg->body.border.color = LV_COLOR_HEX(0x832A34);
    ...
    style_rel->body.border.color = LV_COLOR_HEX(0x832A34);
    style_rel->body.border.width = 3;
    style_rel->body.border.opa = LV_OPA_100;
    style_rel->body.radius = 15;
    style_rel->text.color = LV_COLOR_HEX(0x832A34);
    ...
    style_pr->body.main_color = LV_COLOR_HEX(0x832A34);
    style_pr->body.grad_color = LV_COLOR_HEX(0x832A34);
    ...
    style_ina->text.color = LV_COLOR_HEX(0x832A34);
    ...
    lv_obj_t *colorSwitch = lv_sw_create(m_screenContainer, 0);
    lv_obj_set_size(colorSwitch, lv_obj_get_width(screenParent)/2, lv_obj_get_height(screenParent)/4);
    lv_obj_align(colorSwitch, 0, LV_ALIGN_IN_BOTTOM_MID, 0, -lv_obj_get_height(screenParent)/8);
    ...
    knob_off_style->body.border.color = LV_COLOR_HEX(0x832A34);
